...
Функция ОписаниеТипаСправочник(ИмяСправочника) Экспорт
	...
	Возврат Новый ОписаниеТипов("СправочникСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяСправочника));
...
Функция ОписаниеТиповСправочников(ИменаСправочников) Экспорт
	...
	ИменаСправочников = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаСправочников, ",");
...
Функция ОписаниеТипаДокумент(ИмяДокумента) Экспорт
	...
	Возврат Новый ОписаниеТипов("ДокументСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяДокумента));
...
Функция ОписаниеТиповДокументов(ИменаДокументов) Экспорт
	...
	ИменаДокументов = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаДокументов, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаПеречисление(ИмяПеречисления) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПеречислениеСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяПеречисления));
...
Функция ОписаниеТиповПеречислений(ИменаПеречислений) Экспорт
	...
	ИменаПеречислений = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаПеречислений, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаПланВидовХарактеристик(ИмяПланаВидовХарактеристик) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПланВидовХарактеристикСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяПланаВидовХарактеристик));
...
Функция ОписаниеТиповПлановВидовХарактеристик(ИменаПлановВидовХарактеристик) Экспорт
	...
	ИменаПлановВидовХарактеристик = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаПлановВидовХарактеристик, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТиповХарактеристик(ИмяПланаВидовХарактеристик) Экспорт
	...
	Возврат ОписаниеТипаПоЗначению(_ТипЗначенияВызовСервера.МассивТиповХарактеристик(ИмяПланаВидовХарактеристик));
...
Функция ОписаниеТипаПланВидовРасчета(ИмяПланаВидовРасчета) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПланВидовРасчетаСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяПланаВидовРасчета));
...
Функция ОписаниеТиповПлановВидовРасчета(ИменаПлановВидовРасчета) Экспорт
	...
	ИменаПлановВидовРасчета = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаПлановВидовРасчета, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаБизнесПроцесс(ИмяБизнесПроцесса) Экспорт
	...
	Возврат Новый ОписаниеТипов("БизнесПроцессСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяБизнесПроцесса));
...
Функция ОписаниеТиповБизнесПроцессов(ИменаБизнесПроцессов) Экспорт
	...
	ИменаБизнесПроцессов = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаБизнесПроцессов, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаЗадача(ИмяЗадачи) Экспорт
	...
	Возврат Новый ОписаниеТипов("ЗадачаСсылка." + _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИмяЗадачи));
...
Функция ОписаниеТиповЗадач(ИменаЗадач) Экспорт
	...
	ИменаЗадач = _ОбработкаСтрок.ОчиститьОтЗапрещенныхСимволов(ИменаЗадач, ",");
	МассивТипов = Новый Массив;

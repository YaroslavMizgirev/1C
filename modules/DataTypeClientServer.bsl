//////////////////////////////////////////////////////////////////////////////////
//
//	Общий модуль: Тип данных (клиент сервер)
//	
...
// Функция - Описание типа по значению.
//  Создание нового описания типа по переданному значению.
//
// Параметры:
//  МассивСТипами - Массив Из Тип(Произвольный) - Массив типов с произвольными значениями типа.
// 
// Возвращаемое значение:
//   - ОписаниеТипов - Описание типа с произвольными значениями.
//
Функция ОписаниеТипаПоЗначению(МассивСТипами) Экспорт
	
	Возврат Новый ОписаниеТипов(МассивСТипами);
...
Функция ОписаниеТипаСправочник(ИмяСправочника) Экспорт
	...
	Возврат Новый ОписаниеТипов("СправочникСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяСправочника));
...
Функция ОписаниеТиповСправочников(ИменаСправочников) Экспорт
	...
	ИменаСправочников = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаСправочников, ",");
...
Функция ОписаниеТипаДокумент(ИмяДокумента) Экспорт
	...
	Возврат Новый ОписаниеТипов("ДокументСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяДокумента));
...
Функция ОписаниеТиповДокументов(ИменаДокументов) Экспорт
	...
	ИменаДокументов = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаДокументов, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаПеречисление(ИмяПеречисления) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПеречислениеСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяПеречисления));
...
Функция ОписаниеТиповПеречислений(ИменаПеречислений) Экспорт
	...
	ИменаПеречислений = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаПеречислений, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаПланСчетов(ИмяПланаСчетов) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПланСчетовСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяПланаСчетов));
...
Функция ОписаниеТипаПланВидовХарактеристик(ИмяПланаВидовХарактеристик) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПланВидовХарактеристикСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяПланаВидовХарактеристик));
...
Функция ОписаниеТиповПлановВидовХарактеристик(ИменаПлановВидовХарактеристик) Экспорт
	...
	ИменаПлановВидовХарактеристик = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаПлановВидовХарактеристик, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТиповХарактеристик(ИмяПланаВидовХарактеристик) Экспорт
	...
	#Если ТонкийКлиент Или МобильныйКлиент Или ВебКлиент Или ТолстыйКлиентУправляемоеПриложение Тогда
		Возврат ОписаниеТипаПоЗначению(DataTypeServerCall.МассивТиповХарактеристик(ИмяПланаВидовХарактеристик));
...
Функция ОписаниеТипаПланВидовРасчета(ИмяПланаВидовРасчета) Экспорт
	...
	Возврат Новый ОписаниеТипов("ПланВидовРасчетаСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяПланаВидовРасчета));
...
Функция ОписаниеТиповПлановВидовРасчета(ИменаПлановВидовРасчета) Экспорт
	...
	ИменаПлановВидовРасчета = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаПлановВидовРасчета, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаБизнесПроцесс(ИмяБизнесПроцесса) Экспорт
	...
	Возврат Новый ОписаниеТипов("БизнесПроцессСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяБизнесПроцесса));
...
Функция ОписаниеТиповБизнесПроцессов(ИменаБизнесПроцессов) Экспорт
	...
	ИменаБизнесПроцессов = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаБизнесПроцессов, ",");
	МассивТипов = Новый Массив;
...
Функция ОписаниеТипаЗадача(ИмяЗадачи) Экспорт
	...
	Возврат Новый ОписаниеТипов("ЗадачаСсылка." + StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИмяЗадачи));
...
Функция ОписаниеТиповЗадач(ИменаЗадач) Экспорт
	...
	ИменаЗадач = StringProcessingClientServer.ОчиститьОтЗапрещенныхСимволов(ИменаЗадач, ",");
	МассивТипов = Новый Массив;
